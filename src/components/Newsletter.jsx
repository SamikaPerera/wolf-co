  ...
  return (
    <section className="py-20 border-t border-white/[0.06]" style={{ background: 'var(--gray-dark)' }}>
      ...
      >
        ...
        <h2 className="font-bebas text-4xl sm:text-5xl tracking-wider mt-4 mb-2">STAY IN THE PACK</h2>
        ...
        {!done ? (
          ...
          <div className="flex items-center justify-center gap-3 py-3">
            ...
            <span className="font-condensed text-sm tracking-widest uppercase text-white/50">You're in the pack.</span>
          </div>
        )}
      </motion.div>
    </section>
